  ...
  return (
    <section>
      ...
      <p className="my-5 text-neutral-800 dark:text-neutral-200">
        Custom websites and web apps for agencies and growing businesses — fast,
        scalable, and free from vendor lock-in.
      </p>

      <div className="prose prose-neutral dark:prose-invert text-neutral-800 dark:text-neutral-200">
        <hr />
        <p>
          I design and build modern digital platforms with an owner-first stack.
          Your team keeps control of the codebase, hosting, domain, and
